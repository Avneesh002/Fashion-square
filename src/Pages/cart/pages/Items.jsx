...
const Items = ({id,title,Quantity,price,img}) => {
    ...
    return (
        <>
        <div className='shadow' style={{textAlign:"center" ,boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px",marginLeft:"18%",marginTop:"51px" , width:"67%"}} >
        <div style={{display:"flex",gap:"91px",marginBottom:"51px",paddingTop:"61px"}} >
