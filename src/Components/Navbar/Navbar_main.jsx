        ...
        <>
            <header>
                <div className='container'>
                    ...
                    <nav>
                        <ul>
                            <li className='hover-effect'><a href="#">WOMEN</a></li>
                                ...
                                <div className='mega-menu'>
                                    ...
                                    <div className='mega-menu-items'>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#">Ethnic Wear Sets</a></li>
                                            <li><a href="#">Nehru Jackets</a></li>
                                            <li><a href="#">Ethnic Bottom Wear</a></li>
                                    ...
                                    <div className='mega-menu-items'>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#">Jutis And Mojaris</a></li>
                                    ...
                                    <div className='mega-menu-items'>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#">Lapel Pins & Brooch</a></li>
                                            <li><a href="#">Ties & Pocket Squares</a></li>
                                            <li><a href="#">Cufflinks & Bracelets</a></li>
                                            <li><a href="#">Suits & Blazers</a></li>
                                    ...
                                    <div className='mega-menu-items'>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#">Campus Sutra</a></li>
                                            <li><a href="#">Ruggers</a></li>
                                            <li><a href="#">Canary London</a></li>
                            ...
                            <li className='hover-effect'><a href="#">KIDS</a></li>
                            <li className='hover-effect'><a href="#">HOME</a></li>
                            <li className='hover-effect'><a style={{color:"red", fontWeigth:"bold"}} href="#">OFFERS</a></li>
                        </ul>
                    </nav>
